        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px; background-color:white;color:black">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5" style="font-size: 30px">Add Products</h2>
              ...
              <form  action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-4">
                  ...
                  <input type="text" id="form3Example1cg" class="form-control form-control-lg" style="color:white;background-color:black" name="productname" required/>
                </div>

                <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example3cg">Price</label>
                  <input type="number" id="form3Example3cg" class="form-control form-control-lg" style="color:white;background-color:black" name="price" required />
                </div>

                <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example4cg">Description</label>
                  <input type="text" id="form3Example4cg" class="form-control form-control-lg" style="color:white;background-color:black" name="description" required />
                </div>

                <div class="form-outline mb-4">
                  <label class="form-label" for="form3Example4cdg">Quantity</label>
                  <input type="number" id="form3Example4cdg" class="form-control form-control-lg" style="color:white;background-color:black" name="quantity" required/>
                </div>
